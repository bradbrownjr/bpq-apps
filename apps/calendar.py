...
def show_logo():
    ...
    logo = r"""
                 _                 _
  ___  __ _ ___| | ___  _ __   __| | __ _ _ __
 / __\/ _` / __| |/ _ \| '_ \ / _` |/ _` | '__|
| (__| (_| \__ \ |  __/| | | | (_| | (_| | |
 \___|\__,_|___/_|\___||_| |_|\__,_|\__,_|_|
"""
    print(logo)
...
def check_for_app_update(current_version, script_name):
    ...
    try:
        url = "https://raw.githubusercontent.com/ect/bpq-apps/main/apps/{}".format(script_name)
